...
import HeroBlack from "@/public/fuadhasanemon.png";
import HeroWhite from "@/public/fuadhasanemon.png";
        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            <p className="mt-6 mb-12 font-normal">
              Full-stack Engineer who develops modern, reactive, and
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("fuadhasanemon8@gmail.com")
                }
